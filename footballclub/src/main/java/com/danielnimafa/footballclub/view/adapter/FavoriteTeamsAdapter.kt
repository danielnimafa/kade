...
import com.danielnimafa.footballclub.R.id.team_badge
import com.danielnimafa.footballclub.R.id.team_name
...
class FavoriteTeamsAdapter(private val favorite: List<Favorite>, private val listener: (Favorite) -> Unit)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FavoriteViewHolder {
        return FavoriteViewHolder(TeamUIFav().createView(AnkoContext.create(parent.context, parent)))
    }
...
class TeamUIFav : AnkoComponent<ViewGroup> {
